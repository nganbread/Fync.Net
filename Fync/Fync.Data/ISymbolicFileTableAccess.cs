...
namespace Fync.Data
{
    public interface ISymbolicFileTableAccess
    {
        ...
        void AddSymbolicFileToFolder(Guid folderId, string hash, string fileName, DateTime createdDate);
        ...
        void DeleteSymbolicFilesFromFolder(IEnumerable<SymbolicFileTableEntity> symbolicFiles);
    }
}